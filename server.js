...
app.listen(PORT, () => {
  ...
  if (saved) {
    ...
    // Ensure official token CA is never overwritten by old disk saves
    gameState.token = {
      name: '$SOLPOT',
      mint: 'DQeKCYQzh5EGZUk363nC4LqWbBm5owcUNF8pvLvipump',
      minRequired: 10000,
    ...
    gameState.health.lastReadAt = Date.now();
    saveState();
    console.log(`📂 State restored! Round ${gameState.round}, Pot: ${gameState.potSol} SOL, Token CA: ${gameState.token.mint}`);
  }
  console.log(`====================================================`);
